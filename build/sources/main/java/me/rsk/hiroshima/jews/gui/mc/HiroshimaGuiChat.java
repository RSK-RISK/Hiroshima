package me.rsk.hiroshima.jews.gui.mc;
...
public class HiroshimaGuiChat extends GuiChat {

    private String startString;
    private String currentFillinLine;
    private int cursor;

    public HiroshimaGuiChat(String startString, String historybuffer, int sentHistoryCursor) {
        super(startString);
    ...
    protected void keyTyped(char typedChar, int keyCode) throws IOException {
        ...
        if (!chatLine.startsWith(Command.getCommandPrefix())){
            GuiChat newGUI = new GuiChat(chatLine) {
                int cursor = HiroshimaGuiChat.this.cursor;
                @Override
                protected void keyTyped(char typedChar, int keyCode) throws IOException {
                    this.sentHistoryCursor = cursor;
                    super.keyTyped(typedChar, keyCode);
    ...
    protected void calculateCommand(String line){
        ...
        for (Command c : HiroshimaClient.getInstance().getCommandManager().getCommands()) {
