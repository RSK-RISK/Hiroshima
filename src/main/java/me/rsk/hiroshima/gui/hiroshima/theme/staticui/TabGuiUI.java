package me.rsk.hiroshima.gui.hiroshima.theme.staticui;

import me.rsk.hiroshima.gui.hiroshima.HiroshimaGUI;
import me.rsk.hiroshima.gui.hiroshima.component.TabGUI;
...
public class TabGuiUI extends AbstractComponentUI<TabGUI> {
    ...
    public void renderComponent(TabGUI component, FontRenderer fontRenderer) {
        ...
        HiroshimaGUI.primaryColour.setGLColour();
        glColor3f(0f,170f,170f);
        ...
        for(int i = 0; i < component.tabs.size(); i++)
        {
            ...
            Wrapper.getFontRenderer().drawStringWithShadow(2, textY,255,255,255,"\u00A71"+tabName);
            textY += 10;
        }
        ...
        if(component.tabOpened)
        {
            ...
            for(int i = 0; i < tab.features.size(); i++)
            {
                ...
                String fName = (feature.isEnabled() ? "\u00A73" : "\u00A7f") + feature.getName();
                ...
                GL11.glEnable(GL11.GL_TEXTURE_2D);
                GL11.glColor3f(1,1,1);
                Wrapper.getFontRenderer().drawStringWithShadow(2, tabTextY, 0,170,170, fName);
                tabTextY += 10;
            }
