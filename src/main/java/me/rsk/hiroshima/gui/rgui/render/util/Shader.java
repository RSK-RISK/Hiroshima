package me.rsk.hiroshima.gui.rgui.render.util;

import java.util.HashMap;
import java.util.Map;

import static me.rsk.hiroshima.gui.rgui.render.util.ShaderHelper.createProgram;
import static me.rsk.hiroshima.gui.rgui.render.util.ShaderHelper.loadShader;
