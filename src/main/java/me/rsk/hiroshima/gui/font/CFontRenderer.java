package me.rsk.hiroshima.gui.font;
...
public class CFontRenderer extends CFont {
	...
	public void drawStringWithShadow2(String hiroshima, float floatValue, float v, int color2, String pvp, float floatValue1, float v1) {
	}
}