package me.rsk.hiroshima.module;

import me.rsk.hiroshima.HiroshimaClient;
import me.rsk.hiroshima.event.events.RenderEvent;
import me.rsk.hiroshima.module.modules.ClickGUI;
import me.rsk.hiroshima.util.ClassFinder;
...
public class ModuleManager {
    ...
    public static void initialize() {
        ...
        HiroshimaClient.log.info("Modules initialised");
    ...
    public static void onWorldRender(RenderWorldLastEvent event) {
        Minecraft.getMinecraft().profiler.startSection("hiroshima");
...
//        GlStateManager.pushMatrix();
        ...
        RenderEvent e = new RenderEvent(HiroshimaTessellator.INSTANCE, renderPos);
        e.resetTranslation();
