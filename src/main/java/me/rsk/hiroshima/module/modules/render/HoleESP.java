...
public class HoleESP
    ...
    private Setting<Integer> obbyRed = this.register(Settings.integerBuilder("Obbi Red").withMinimum(0).withMaximum(255).withValue(255).build());
    private Setting<Integer> obbyGreen = this.register(Settings.integerBuilder("Obbi Green").withMinimum(0).withMaximum(255).withValue(100).build());
    ...
    private Setting<Integer> bRockGreen = this.register(Settings.integerBuilder("BRock Green").withMinimum(0).withMaximum(255).withValue(0).build());
    ...
    private Setting<Integer> alpha = this.register(Settings.integerBuilder("Alpha").withMinimum(0).withMaximum(255).withValue(20).build());
    ...
    private Setting<Float> width = this.register(Settings.floatBuilder("Line Width").withMinimum(Float.valueOf(0.0f)).withMaximum(Float.valueOf(7.0f)).withValue(Float.valueOf(1.0f)).build());
    ...
    public void onWorldRender(RenderEvent event) {
        ...
        if (this.render != null) {
            for (BlockPos hole : this.findObbyHoles()) {
                if (this.obbyChroma.getValue().booleanValue()) {
                    if (this.highlight.getValue().booleanValue()) {
                        ...
                        HiroshimaTessellator.drawBox(hole, red, green, blue, this.alpha.getValue(), 63);
                        HiroshimaTessellator.release();
                    }
                    if (this.box.getValue().booleanValue()) {
                        HiroshimaTessellator.prepare(7);
                        HiroshimaTessellator.drawBoundingBoxBlockPos(hole, this.width.getValue().floatValue(), red, green, blue, this.alpha2.getValue());
                        HiroshimaTessellator.release();
                    }
                    if (this.bottom.getValue().booleanValue()) {
                        HiroshimaTessellator.prepare(7);
                        HiroshimaTessellator.drawBoxBottom(hole, red, green, blue, this.alpha.getValue());
                        HiroshimaTessellator.release();
                    }
                    if (!this.bottomBox.getValue().booleanValue()) continue;
                    HiroshimaTessellator.prepare(7);
                    HiroshimaTessellator.drawBoundingBoxBottomBlockPos(hole, this.width.getValue().floatValue(), red, green, blue, this.alpha2.getValue());
                    HiroshimaTessellator.release();
                    continue;
                }
                if (this.highlight.getValue().booleanValue()) {
                    HiroshimaTessellator.prepare(7);
                    HiroshimaTessellator.drawBox(hole, this.obbyRed.getValue(), this.obbyGreen.getValue(), this.obbyBlue.getValue(), this.alpha.getValue(), 63);
                    HiroshimaTessellator.release();
                }
                if (this.box.getValue().booleanValue()) {
                    HiroshimaTessellator.prepare(7);
                    HiroshimaTessellator.drawBoundingBoxBlockPos(hole, this.width.getValue().floatValue(), this.obbyRed.getValue(), this.obbyGreen.getValue(), this.obbyBlue.getValue(), this.alpha2.getValue());
                    HiroshimaTessellator.release();
                }
                if (this.bottom.getValue().booleanValue()) {
                    HiroshimaTessellator.prepare(7);
                    HiroshimaTessellator.drawBoxBottom(hole, this.obbyRed.getValue(), this.obbyGreen.getValue(), this.obbyBlue.getValue(), this.alpha.getValue());
                    HiroshimaTessellator.release();
                }
                if (!this.bottomBox.getValue().booleanValue()) continue;
                HiroshimaTessellator.prepare(7);
                HiroshimaTessellator.drawBoundingBoxBottomBlockPos(hole, this.width.getValue().floatValue(), this.obbyRed.getValue(), this.obbyGreen.getValue(), this.obbyBlue.getValue(), this.alpha2.getValue());
                HiroshimaTessellator.release();
            }
            for (BlockPos hole : this.findBRockHoles()) {
                ...
                if (this.highlight.getValue().booleanValue()) {
                    HiroshimaTessellator.prepare(7);
                    HiroshimaTessellator.drawBox(hole, this.bRockRed.getValue(), this.bRockGreen.getValue(), this.bRockBlue.getValue(), this.alpha.getValue(), 63);
                    HiroshimaTessellator.release();
                }
                if (this.box.getValue().booleanValue()) {
                    HiroshimaTessellator.prepare(7);
                    HiroshimaTessellator.drawBoundingBoxBlockPos(hole, this.width.getValue().floatValue(), this.bRockRed.getValue(), this.bRockGreen.getValue(), this.bRockBlue.getValue(), this.alpha2.getValue());
                    HiroshimaTessellator.release();
                }
                if (this.bottom.getValue().booleanValue()) {
                    HiroshimaTessellator.prepare(7);
                    HiroshimaTessellator.drawBoxBottom(hole, this.bRockRed.getValue(), this.bRockGreen.getValue(), this.bRockBlue.getValue(), this.alpha.getValue());
                    HiroshimaTessellator.release();
                }
                if (!this.bottomBox.getValue().booleanValue()) continue;
                HiroshimaTessellator.prepare(7);
                HiroshimaTessellator.drawBoundingBoxBottomBlockPos(hole, this.width.getValue().floatValue(), this.bRockRed.getValue(), this.bRockGreen.getValue(), this.bRockBlue.getValue(), this.alpha2.getValue());
                HiroshimaTessellator.release();
            }
        }
    }
