package me.rsk.hiroshima.module.modules.movement;
...
@Module.Info(name = "ElytraFly", description = "Allows infinite elytra flying", category = Module.Category.MOVEMENT)
