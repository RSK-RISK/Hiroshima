...
import me.rsk.hiroshima.util.HueCycler;
import me.rsk.hiroshima.util.HiroshimaTessellator;
import me.rsk.hiroshima.util.TrajectoryCalculator;
 ...
 */
@Module.Info(name = "FlightPath", category = Module.Category.RENDER)
        ...
        try {
            mc.world.loadedEntityList.stream()
                ...
                if (hit != null){
                    ...
                    HiroshimaTessellator.drawBox(hit, 0x33ffffff, GeometryMasks.FACEMAP.get(flightPath.getCollidingTarget().sideHit));
