...
import me.rsk.hiroshima.util.GeometryMasks;
...
import static me.rsk.hiroshima.module.modules.combat.HiroshimaCA.getPlayerPos;
...
public class VoidESP extends Module {
    ...
    private Setting<Integer> activateAtY = register(Settings.integerBuilder("ActivateAtY").withMinimum(1).withValue(20).withMaximum(512).build());
    ...
    private void drawBlock(BlockPos blockPos, int r, int g, int b) {
        ...
        HiroshimaTessellator.drawBox(blockPos, color.getRGB(), mask);
    }
