package me.rsk.hiroshima.setting.config;
...
import me.rsk.hiroshima.setting.converter.Convertable;
...
public class Configuration {
    ...
    public static void loadConfiguration(InputStream stream) {
        try {
            ...
            HiroshimaClient.log.error("hiroshima Config malformed: resetting.");
