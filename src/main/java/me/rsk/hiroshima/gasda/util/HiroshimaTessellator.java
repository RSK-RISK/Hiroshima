package me.rsk.hiroshima.gasda.util;
 ...
 */
public class HiroshimaTessellator extends Tessellator {

    public static HiroshimaTessellator INSTANCE = new HiroshimaTessellator();

    public HiroshimaTessellator() {
        super(0x200000);
    }
...
//        GlStateManager.blendFunc(GlStateManager.SourceFactor.ONE, GlStateManager.DestFactor.ZERO);
    ...
    public static void drawBoxBottom(BlockPos blockPos, int argb) {
        ...
        int g = argb >>> 8 & 255;
        int b = argb & 255;
        HiroshimaTessellator.drawBoxBottom(blockPos, r, g, b, a);
    }
    ...
    public static void drawBoxBottom(float x, float y, float z, int argb) {
        ...
        int g = argb >>> 8 & 255;
        int b = argb & 255;
        HiroshimaTessellator.drawBoxBottom(INSTANCE.getBuffer(), x, y, z, 1.0f, 1.0f, 1.0f, r, g, b, a);
    }


    public static void drawBoxBottom(BlockPos blockPos, int r, int g, int b, int a) {
        HiroshimaTessellator.drawBoxBottom(INSTANCE.getBuffer(), blockPos.x, blockPos.y, blockPos.z, 1.0f, 1.0f, 1.0f, r, g, b, a);
    }
