...
import me.rsk.hiroshima.jews.module.modules.misc.DiscordRPCModule;
import net.minecraft.client.Minecraft;
import net.minecraft.client.multiplayer.ServerData;
import net.minecraftforge.fml.common.FMLLog;

import static me.rsk.hiroshima.HiroshimaClient.MODVER;

public class DiscordPresence {
    private static final String APP_ID = "705066191026127010";
    ...
    public static void start() {
        ...
        DiscordPresence.presence.largeImageText = "Hiroshima";
